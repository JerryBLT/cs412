...
def load_data():
    ...
    filename = '/Users/jerryteixeira/Desktop/CS412/2023_chicago_results.csv'
    f = open(filename, 'r')
    ...
    # Reat the entire file, one line at a time
    for line in f:
        try:
    ...
    print(f"Done. Created {len(Result.objects.all())} resutls" )
